---
{"dg-publish":true,"permalink":"/1-cs/7/","created":"2025-03-08T19:30:28.835+09:00","updated":"2025-03-13T17:48:38.702+09:00"}
---
...
def partition(alist, first, last):
    ...
    return rightmark
```
![Pasted image 20250313174151.png](/img/user/Pasted%20image%2020250313174151.png)
...
- **개념**: 중복되는 **하위 문제의 결과를 저장(메모이제이션 또는 타뷸레이션)하여 효율적으로 문제를 해결**하는 방법.
...
#### Dijkstra
![Pasted image 20250313174320.png](/img/user/Pasted%20image%2020250313174320.png)
...
#### Bellman-Ford
![Pasted image 20250313174347.png](/img/user/Pasted%20image%2020250313174347.png)
